...
## 该项目基于LunaTV v100版本的基础上进行修改并自行维护该项目，采取相同开源协议。
...
services:
  ShenYuTV-core:
    image: crpi-xocxjeo95fhsjmg7.cn-shanghai.personal.cr.aliyuncs.com/tanxin88/shenyutv:1.1
    container_name: ShenYuTV-core
    restart: on-failure
    ports:
      - '3000:3000'
    environment:
  ...
  ShenYuTV-kvrocks:
    ...
    container_name: ShenYuTV-kvrocks
...
ShenYuTV 支持标准的苹果 CMS V10 API 格式。
...
| NEXT_PUBLIC_SITE_NAME    | 站点名称                 | 任意字符串               | ShenYuTV                                                                                                                   |
...
| SMTP_HOST                | 请求邮箱api地址          | 可选smtp.qq.com          | smtp.qq.com                                                                                                                |
| SMTP_PORT                | 请求邮箱端口             | 465                      | 465                                                                                                                        |
| SMTP_USER                | 请求邮箱地址             | xxx@qq.com               | 无                                                                                                                         |
| SMTP_FROM                | 请发送邮箱来源           | ShenyuTV xxx@qq.com      | ShenyuTV xxx@qq.com                                                                                                        |
| SMTP_PASS                | 请求密钥                 | 无                       | 无                                                                                                                         |
...
配合 [Selene](https://github.com/MoonTechLab/Selene) 使用，移动端体验更加友好，数据完全同步
...
[MIT](LICENSE) © 2026 ShenYuTV & Contributors
